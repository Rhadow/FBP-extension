...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_Root2.default, null), document.getElementById('FBP-root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./../node_modules/postcss-loader/index.js!./_index.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./../node_modules/postcss-loader/index.js!./_index.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#FBP-root {\n  position: fixed;\n  width: 100%;\n  height: 5000px;\n  z-index: 500; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FBDialogBox = function (_Component) {
		_inherits(FBDialogBox, _Component);

		function FBDialogBox() {
			_classCallCheck(this, FBDialogBox);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(FBDialogBox).apply(this, arguments));
		}

		_createClass(FBDialogBox, [{
			key: 'render',
			value: function render() {
				...
				var confirmButtonText = _props.confirmButtonText;
				var cancelButtonText = _props.cancelButtonText;
				var onConfirmHandler = _props.onConfirmHandler;
				var onCancelHandler = _props.onCancelHandler;

				var confirmButtonClasses = (0, _classnames2.default)({
					'fb-dialog-box__confirm-button': confirmButtonText,
					'fb-dialog-box__confirm-button--hide': !confirmButtonText
				}),
				    cancelButtonClasses = (0, _classnames2.default)({
					'fb-dialog-box__cancel-button': cancelButtonText,
					'fb-dialog-box__cancel-button--hide': !cancelButtonText
				});
				return _react2.default.createElement(
					'div',
					{ className: 'fb-dialog-box' },
					_react2.default.createElement('div', { className: 'fb-dialog-box__top-shade' }),
					_react2.default.createElement(
						'div',
						{ className: 'fb-dialog-box__title' },
						title
					),
					_react2.default.createElement(
						'div',
						{ className: 'fb-dialog-box__subtitle' },
						subtitle
					),
					_react2.default.createElement(
						'div',
						{ className: 'fb-dialog-box__body' },
						body
					),
					_react2.default.createElement(
						'div',
						{ className: 'fb-dialog-box__footer' },
						_react2.default.createElement(
							'div',
							{ className: confirmButtonClasses, onClick: onConfirmHandler },
							_react2.default.createElement(
								'div',
								{ className: 'fb-dialog-box__confirm-button--inner' },
								confirmButtonText
							)
						),
						_react2.default.createElement(
							'div',
							{ className: cancelButtonClasses, onClick: onCancelHandler },
							_react2.default.createElement(
								'div',
								{ className: 'fb-dialog-box__cancel-button--inner' },
								cancelButtonText
							)
						)
					),
					_react2.default.createElement('div', { className: 'fb-dialog-box__bottom-shade' })
				);
			}
		}]);
	...
	FBDialogBox.propTypes = {
		...
		onConfirmHandler: _react.PropTypes.func,
		onCancelHandler: _react.PropTypes.func
	};

	FBDialogBox.defaultProps = {
		title: '',
		subtitle: '',
		body: _react2.default.createElement('div', null),
		confirmButtonText: '',
		cancelButtonText: '',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./../../../node_modules/postcss-loader/index.js!./_FB-Dialog-Box.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./../../../node_modules/postcss-loader/index.js!./_FB-Dialog-Box.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".fb-dialog-box {\n  position: absolute;\n  top: 0;\n  left: 25%;\n  top: 3%;\n  display: inline-block;\n  width: 50%;\n  z-index: 600; }\n\n.fb-dialog-box_clear {\n  clear: both; }\n\n.fb-dialog-box_right {\n  float: right; }\n\n.fb-dialog-box__cancel-button {\n  margin-left: 10px;\n  border: solid 1px #9b9b9b;\n  cursor: pointer;\n  display: inline-block; }\n\n.fb-dialog-box__cancel-button--hide {\n  display: none; }\n\n.fb-dialog-box__cancel-button--inner {\n  padding: 4px 6px;\n  border-top: 1px solid #fff;\n  text-align: center;\n  font-weight: bold;\n  font-size: 12px;\n  color: #333;\n  background-color: #e1e0e0; }\n\n.fb-dialog-box__confirm-button {\n  border: solid #29447e 1px;\n  border-bottom: solid #1a356e 1px;\n  cursor: pointer;\n  display: inline-block; }\n\n.fb-dialog-box__confirm-button--hide {\n  display: none; }\n\n.fb-dialog-box__confirm-button--inner {\n  padding: 4px 6px;\n  border-top: 1px solid #8a9cc2;\n  text-align: center;\n  font-weight: bold;\n  font-size: 12px;\n  color: #fff;\n  background-color: #5c75a9; }\n\n.fb-dialog-box__bottom-shade {\n  height: 10px;\n  background-color: #848484; }\n\n.fb-dialog-box__top-shade {\n  height: 10px;\n  background-color: #848484; }\n\n.fb-dialog-box__footer {\n  padding: 8px 10px;\n  height: 26px;\n  text-align: right;\n  border-top: solid 1px #ddd;\n  background-color: #f0f0f0; }\n\n.fb-dialog-box__body {\n  padding: 10px;\n  background-color: #fff; }\n\n.fb-dialog-box__subtitle {\n  padding: 8px 10px;\n  font-size: 12px;\n  border-bottom: solid 1px #ddd;\n  color: #666;\n  background-color: #f0f0f0; }\n\n.fb-dialog-box__title {\n  padding: 6px 6px 6px 8px;\n  font-size: 14px;\n  font-weight: bold;\n  border: solid 1px #3b5998;\n  color: #fff;\n  background-color: #6e84b5; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FBDialogBox = __webpack_require__(171);

	var _FBDialogBox2 = _interopRequireDefault(_FBDialogBox);

	var _Hint = __webpack_require__(161);
		...
		_createClass(Root, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_FBDialogBox2.default, {
						title: 'Title',
						subtitle: 'Subtitle',
						body: _react2.default.createElement(_Hint2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Background = function (_Component) {
		...
		_createClass(Background, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement('div', { className: 'background' });
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./../../../node_modules/postcss-loader/index.js!./_Background.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./../../../node_modules/postcss-loader/index.js!./_Background.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
